# -----------------------------------------------------------------------------
# Prod Environment — ShopSimple
# Multi-region: us-east-1 (primary) + ap-southeast-1 (secondary)
# Active-passive architecture with full HA
# -----------------------------------------------------------------------------
...
# Multi-AZ enabled with deletion protection for HA
# -----------------------------------------------------------------------------
module "rds" {
  source = "../../modules/rds"
...
# Cluster mode enabled with 3 nodes for HA
# -----------------------------------------------------------------------------
module "elasticache" {
